...
config :hn_bookshelf, HnBookshelfWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: HnBookshelfWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: HnBookshelf.PubSub,
  live_view: [signing_salt: "4y0r9LEn"]
...
config :hn_bookshelf, HnBookshelf.Mailer, adapter: Swoosh.Adapters.Local
